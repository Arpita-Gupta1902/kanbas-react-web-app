...
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "300px", paddingLeft: "15px"}}>
      <h2>Course Status</h2>
      <div className="d-flex">
        <div className="w-60 pe-1">
          <button className="btn btn-lg btn-secondary w-100 text-nowrap ">
            <MdDoNotDisturbAlt className="fs-5" /> Unpublish </button>
        </div>
        <div className="w-50">
          <button className="btn btn-lg btn-success w-100">
            <FaCheckCircle className="me-1 fs-5" /> Publish </button>
        </div>
      </div><br />
      ...
      <button className="btn btn-lg btn-secondary w-100 mt-1 text-start" style={{ fontSize: "1.19rem" }}>
